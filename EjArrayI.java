...
public class EjArrayI {
    public static void main(String[] args) {
        ...
        System.out.println(
                "El numero de celdas pares es " + par + " mientras que el numero de celdas impares es " + impar);
        ...
        while (matematicas == false) {
            if (notas[0] >= 0 && notas[0] <= 10) {
                ...
                System.out.println(
                        "Las notas solo pueden tener un valor entre 0 y 10. Por favor vuelva a introducir la nota.");
                notas[0] = in.nextInt();
            }
        }
