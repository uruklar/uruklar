...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numEspectadores && cine.haySitio(); i++) {
            ...
            e = new Espectador(
                    Nombres.nombres[Metodos.generarNumeroAleatorioEntero(0, Nombres.nombres.length - 1)], //Nombre al azar
                    Metodos.generarNumeroAleatorioEntero(10, 30), //Generamos una edad entre 10 y 30
                    Metodos.generarNumeroAleatorioEntero(1, 10)); //Generamos el dinero entre 1 y 10 euros
            ...
            do {
                ...
                fila = Metodos.generarNumeroAleatorioEntero(0, cine.getFilas() - 1);
                letra = (char) Metodos.generarNumeroAleatorioEntero('A', 'A' + (cine.getColumnas()-1));
